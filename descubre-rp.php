<?php 
    ...
    if (!$conexion) {
        ...
        WHERE Album.genero = 'Rock Progresivo'
        ...
        WHERE Artista.genero = 'Rock Progresivo'
        ...
        JOIN Artista ON Album.idArtista = Artista.id
        JOIN Usuario_escucha_Cancion ON Cancion.id = Usuario_escucha_Cancion.idCancion
        WHERE Cancion.genero = 'Rock Progresivo'
    ...
    <main>
            ...
            <div id="inicio">
                <section id="generos">
                    ...
                    <div class="opcion_d"><a href="descubre-rp.php">Rock Progresivo</a></div>
